module github.com/datachainlab/ethereum-light-client-types/e2e/client
...
// always test against the working tree of this repository
replace github.com/datachainlab/ethereum-light-client-types => ../../
