...
func (lcu *LightClientUpdateData) ToProto() *types.ConsensusUpdate {
	executionRoot := lcu.FinalizedHeader.GetExecutionRoot()
	return &types.ConsensusUpdate{
...
func (sc *SyncCommittee) ToProto() *types.SyncCommittee {
...
func (lcf *LightClientFinalityUpdate) ToProto() *types.ConsensusUpdate {
	return &types.ConsensusUpdate{
...
func (h *LightClientHeader) ToProto() *types.BeaconBlockHeader {
...
func (c *SyncAggregate) ToProto() *types.SyncAggregate {
