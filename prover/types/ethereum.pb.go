...
type ForkSpec struct {
	...
	ExecutionBlockHashGindex          uint32 `protobuf:"varint,7,opt,name=execution_block_hash_gindex,json=executionBlockHashGindex,proto3" json:"execution_block_hash_gindex,omitempty"`
}
...
func (m *ForkSpec) GetExecutionBlockHashGindex() uint32 {
	if m != nil {
		return m.ExecutionBlockHashGindex
	}
	return 0
}
...
type ExecutionUpdate struct {
	...
	BlockHashBranch   [][]byte `protobuf:"bytes,7,rep,name=block_hash_branch,json=blockHashBranch,proto3" json:"block_hash_branch,omitempty"`
}
...
func (m *ExecutionUpdate) GetRlp() []byte {
	if m != nil {
		return m.Rlp
	}
	return nil
...
var fileDescriptor_375052802109acf0 = []byte{
	...
	,
}
...
func (m *ForkSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.ExecutionBlockHashGindex != 0 {
		i = encodeVarintEthereum(dAtA, i, uint64(m.ExecutionBlockHashGindex))
		i--
		dAtA[i] = 0x38
	}
...
func (m *ExecutionUpdate) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Rlp) > 0 {
		i -= len(m.Rlp)
		copy(dAtA[i:], m.Rlp)
		i = encodeVarintEthereum(dAtA, i, uint64(len(m.Rlp)))
		i--
		dAtA[i] = 0x2a
	}
...
func (m *ForkSpec) Size() (n int) {
	...
	if m.ExecutionBlockHashGindex != 0 {
		n += 1 + sovEthereum(uint64(m.ExecutionBlockHashGindex))
	}
	return n
}
...
func (m *ForkSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExecutionBlockHashGindex", wireType)
			}
			m.ExecutionBlockHashGindex = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowEthereum
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ExecutionBlockHashGindex |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ExecutionUpdate) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Rlp", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.Rlp = append(m.Rlp[:0], dAtA[iNdEx:postIndex]...)
			if m.Rlp == nil {
				m.Rlp = []byte{}
			}
			iNdEx = postIndex
